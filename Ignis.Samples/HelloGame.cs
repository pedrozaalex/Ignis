...
}))
{
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        var rotationSpeed = 0.5f; // radians per second
        var deltaRotation = rotationSpeed * (float)gameTime.ElapsedGameTime.TotalSeconds;
        ...
        if (gameTime.TotalGameTime.TotalSeconds % 1.0 < 0.016) LogWorldMatrices();
    }

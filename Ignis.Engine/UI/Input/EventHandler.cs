...
public class EventHandlers
{
    ...
    public void InvokePointerDown(PointerEvent evt)
    {
        OnPointerDown?.Invoke(evt);
    }

    public void InvokePointerUp(PointerEvent evt)
    {
        OnPointerUp?.Invoke(evt);
    }

    public void InvokePointerMove(PointerEvent evt)
    {
        OnPointerMove?.Invoke(evt);
    }

    public void InvokePointerEnter(PointerEvent evt)
    {
        OnPointerEnter?.Invoke(evt);
    }

    public void InvokePointerLeave(PointerEvent evt)
    {
        OnPointerLeave?.Invoke(evt);
    }

    public void InvokeKeyDown(KeyboardEvent evt)
    {
        OnKeyDown?.Invoke(evt);
    }

    public void InvokeKeyUp(KeyboardEvent evt)
    {
        OnKeyUp?.Invoke(evt);
    }
    ...
    public void InvokeDragStart(DragEvent evt)
    {
        OnDragStart?.Invoke(evt);
    }

    public void InvokeDragOver(DragEvent evt)
    {
        OnDragOver?.Invoke(evt);
    }

    public void InvokeDrop(DragEvent evt)
    {
        OnDrop?.Invoke(evt);
    }

    public void InvokeDragEnd(DragEvent evt)
    {

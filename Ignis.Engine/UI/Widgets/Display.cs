...
public class Tooltip : ViewComponent, IViewContainer
{
    ...
    protected override void OnMount()
    {
        ...
        if (_content is Panel panel) panel.BackgroundColor = _backgroundColor ?? Context!.Theme.TooltipBackground;

        CreateEffect(() => { _content.Layout.Visible = _isVisible.Value; });
    }
